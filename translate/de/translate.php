...
## Error Mensages
##
$LANG['ERROR_ACCESS_DENIED_INVALID_TICKET'] = 'Zugriff verweigert, m&ouml;glicherweise eine ung&uuml;ltige Ticket ID ?';
$LANG['ERROR_EMAIL_PARSE_FAILED'] = 'E-Mail parsen fehlgeschlagen';
$LANG['ERROR_FILE_REJECTED'] = 'Datei {0} abgelehnt!';
$LANG['ERROR_INVALID_FROM_ADDRESS'] = 'Ung&uuml;ltige FROM Adresse';
$LANG['ERROR_INVALID_FILE_TYPE'] = 'Ung&uuml;ltiger Dateityp';
...
$LANG['ERROR_POSSIBLY_INVALID_TICKET'] = 'Zugriff verweigert, m&ouml;glicherweise eine ung&uuml;ltige Ticket ID ?';
//$LANG['ERROR_SEARCH_TERM_MORE_3']
$LANG['ERROR_SECURITY_REPEAT_RESULT_LOCK'] = 'Sicherheitsversto&szlig;. Wiederholte Verst&ouml;sse f&uuml;hren zur Sperrung des Accounts.';
$LANG['ERROR_SECURITY_VIOLATION_YOUR_ACCOUNT_WILL_LOCKED'] = 'Sicherheitsversto&szlig;. Wiederholte Verst&ouml;sse f&uuml;hren zur Sperrung des Accounts.';
$LANG['ERROR_SERVICES_NOT_AVAILABLE'] = 'Dienst nicht verf&uuml;gbar!';
$LANG['ERROR_UNABLE_SEND_MESSAGE_TRY_AGAIN'] = 'Kann Nachricht nicht einf&uuml;gen, bitte erneut versuchen';
$LANG['ERROR_UNABLE_TO_POST_THE_RESPONSE'] = 'Kann Antwort nicht einf&uuml;gen';
$LANG['ERROR_UNABLE_TO_POST_MESSAGE'] = 'Kann Nachricht nicht einf&uuml;gen, bitte erneut versuchen';
...
$LANG['ERROR_YOU_MUST_CHANGE_PASSWORD'] = 'Sie m&uuml;ssen ein neues Passwort vergeben um fortzufahren.';
...
$LANG['LABEL_API'] = 'API';
$LANG['LABEL_APPEND'] = 'Einf&uuml;gen';
$LANG['LABEL_APPEND_SIGNATURE'] = 'Signatur einf&uuml;gen'; 
$LANG['LABEL_ASC'] = 'ASC';
...
$LANG['LABEL_ATTACHMENTS'] = 'Anh&auml;nge';
$LANG['LABEL_AUTO_RESPONSE_EMAIL'] = 'Auto Antwort E-Mail';
$LANG['LABEL_AUTORESPONDERS'] = 'Autoresponders';
$LANG['LABEL_AUTORESP'] = 'AutoResp.';
// Label B
$LANG['LABEL_BASIC'] = 'Basis';
// Label C
$LANG['LABEL_CLOSE'] = 'Schlie&szlig;en';
$LANG['LABEL_CLOSED'] = 'Geschlossen';
$LANG['LABEL_CLOSE_TICKET'] = 'Schlie&szlig;e Ticket';
...
$LANG['LABEL_DELETE'] = 'L&ouml;schen';
$LANG['LABEL_DELETE_DEPT_S'] = 'Abteilung l&ouml;schen';
...
$LANG['LABEL_DEPT_EMAIL'] = 'Abt. E-Mail';
$LANG['LABEL_DEPT_EMAIL_ABOVE'] = 'Abt. E-Mail (oben)';
...
$LANG['LABEL_EMAIL_TEMPLATES'] = 'E-Mail Vorlagen';
...
$LANG['LABEL_HELPDESK_DEFAULT_EMAIL_TEMPLATES'] = 'Standard E-Mail Vorlagen';
...
$LANG['LABEL_HELPDESK_PURGE_LOGS_AFTER'] = 'Protokoll aufr&auml;umen nach';
$LANG['LABEL_HELPDESK_DEFAULT_PAGE_SIZE'] = 'Standard Seiten Gr&ouml;&szlig;e';
$LANG['LABEL_HELPDESK_SELECT_DEFAULT_DEPARTMENT'] = 'Standard Abteilung ausw&auml;hlen';
$LANG['LABEL_HELPDESK_SELECT_DEFAULT_TEMPLATE'] = 'Default Vorlage ausw&auml;hlen';
...
// Label I
$LANG['LABEL_ISSUE_SUMMARY'] = '&Uuml;bersicht der Vorkommen';
// Label J
// Label K
...
$LANG['LABEL_MOBILE_PHONE'] = 'Mobiltelefon';
...
$LANG['LABEL_NEW_TICKET_PRIORITY'] = 'Priorit&auml;t des neuen Tickets';
$LANG['LABEL_NO_MANAGER_ADD_USERS'] = 'Keine User (User hinzuf&uuml;gen)';
$LANG['LABEL_NONE'] = 'Keine';
$LANG['LABEL_NOTE_TITLE'] = 'Notiztitel';
// Label O
$LANG['LABEL_OPEN'] = 'offen';
$LANG['LABEL_OPEN_NEW_TICKET'] = 'Neues Ticket &ouml;ffnen';
$LANG['LABEL_OPEN_TICKET'] = 'Ticket &ouml;ffnen';
$LANG['LABEL_OTHER'] = 'Outro';
$LANG['LABEL_OUTGOING_EMAIL'] = 'Ausgehende E-Mail';
$LANG['LABEL_OVERDUE'] = '&Uuml;berf&auml;llig';
// Label P
...
$LANG['LABEL_PRIMARY_OUTGOING_EMAIL'] = 'Prim&auml;re ausgehende E-Mail';
$LANG['LABEL_PRIORITY'] = 'Priorit&auml;t';
$LANG['LABEL_PRIVATE'] = 'Privat';
$LANG['LABEL_PRIVATE_HIDDEN'] = 'Privat (Versteckt)';
$LANG['LABEL_PUBLIC'] = '&Ouml;ffentlich';
// Label Q
$LANG['LABEL_QUERY'] = 'Abfrage';
$LANG['LABEL_QUERY_RETURNED_ZERO_RESULT'] = 'Abfrage gab 0 Treffer zur&uuml;ck';
// Label R
$LANG['LABEL_RE_ASSIGN_TICKET'] = 'Mitarbeiter zuweisen';
$LANG['LABEL_REOPEN'] = 'Erneut &ouml;ffnen';
$LANG['LABEL_REOPEN_TICKET'] = 'Ticket erneut &ouml;ffnen';
$LANG['LABEL_RESET'] = 'Zur&uuml;cksetzen';
...
$LANG['LABEL_SELECT'] = 'Ausw&auml;hlen';
$LANG['LABEL_SELECT_DEPARTMENT'] = 'Abteilung ausw&auml;hlen';
$LANG['LABEL_SELECT_MANAGER_OPTIONAL'] = 'Abteilungsleiter ausw&auml;hlen (optional)';
$LANG['LABEL_SELECT_ONE_TOPIC'] = 'Eine ausw&auml;hlen';
$LANG['LABEL_SELECT_ONE_EMAIL'] = 'Eine ausw&auml;hlen';
$LANG['LABEL_SELECT_PRIORITY'] = 'Priorit&auml;t ausw&auml;hlen';
$LANG['LABEL_SELECT_SOURCE'] = 'Quelle ausw&auml;hlen';
$LANG['LABEL_SELECT_TEMPLATE'] = 'Vorlage ausw&auml;hlen';
...
$LANG['LABEL_STAFF_VIEWTICKET_SELECT_ACTION']='Aktion ausw&auml;hlen';
$LANG['LABEL_STAFF_VIEWTICKET_CHANGE_PRIORITY']='Priorit&auml;t &auml;ndern';
$LANG['LABEL_STAFF_VIEWTICKET_MARK_OVERDUE']='Als &uuml;berf&auml;llig markieren';
$LANG['LABEL_STAFF_VIEWTICKET_RELEASE_UNASSIGN']='Freigeben (Zuweisung entfernen)';
$LANG['LABEL_STAFF_VIEWTICKET_CLOSE_TICKET']='Ticket schlie&szlig;en';
$LANG['LABEL_STAFF_VIEWTICKET_REOPEN_TICKET']='Ticket erneut &ouml;ffnen';
...
$LANG['LABEL_SYSTEM_LOGS_NO_RESULTS'] = 'Abfrage gab keine Ergebnisse zur&uuml;ck.';
...
// Label T
$LANG['LABEL_ANSWER'] = 'Textbaustein';
...
$LANG['LABEL_TITLE'] = 'Standardantwort';
$LANG['LABEL_TO'] = 'An.';
...
$LANG['TEXT_AND_STATUS_SET_TO'] = ' und Status ge&auml;ndert auf {0}';
...
$LANG['TEXT_ATTACH_FILE'] = 'Datei anh&auml;ngen';
$LANG['TEXT_AUTHENTICATION_REQUIRED'] = 'Anmeldung erforderlich';
$LANG['TEXT_AUTHENTICATION_REQUIRED_QUESTION'] = 'Anmeldung erforderlich ?';
// TEXT B
$LANG['TEXT_BOX_NEW_TICKET'] = 'Ein neues Ticket &uuml;bermittlen. Bitte geben Sie so viele Informationen an wie m&ouml;glich, um den
bestm&ouml;glichen Support bieten zu k&ouml;nnen. Um ein existierendes Ticket zu aktualisieren, benutzen Sie bitte das Formular auf der rechten
Seite.. Eine g&uuml;ltige E-Mail Adresse ist erforderlich !';
// TEXT C
$LANG['TEXT_CAM_BE_APPENDED_TO_RESPONSES'] = 'kann zur Antwort hinzugef&uuml;gt werden.&nbsp;(verf&uuml;gbar f&uuml;r &Ouml;ffentliche Abteilungen)';
$LANG['TEXT_CLOSED_TICKETS'] = 'Geschlossene Tickets';
$LANG['TEXT_CLOSED'] = 'Geschlossen';
$LANG['TEXT_COMMENTS_REASONS_TRANSFER'] = 'Kommentare/Gr&uuml;nde f&uuml;r den Transfer. &nbsp;(<i>Interne Notiz</i>)';
$LANG['TEXT_CREATE_FAILED'] = 'Anlegen fehlgeschlagen ';
// TEXT D
$LANG['TEXT_DEPT_DEPENDS_ON_EMAIL'] = 'Abteilungseinstellungen sind abh&auml;ngig von den E-Mail und Hilfe Kategorie-Einstellungen.';
$LANG['TEXT_DEPT_TRANSFER'] = 'Abteilungs-Transfer';
$LANG['TEXT_DEPT_UPDATED_SUCCESSFULLY'] = 'Abt. erfolgreich aktualisiert';
// TEXT E
$LANG['TEXT_EMAIL_ADDED_TO_BANLIST'] = 'E-Mail ({0}) zur Bannliste hinzugef&uuml;gt';
$LANG['TEXT_EMAIL_ADDRESS_USED_SEND_AUTO_RESPONSES'] = 'E-Mail Adresse f&uuml;r Auto-Antworten, sofern aktiviert.';
$LANG['TEXT_EMAIL_REMOVED_FROM_BANLIST'] = 'E-Mail von der Bannliste entfernt';
...
$LANG['TEXT_HELPDESK_ENABLE_CRON_CALL_ON_STAFF_ACTIVITY'] = 'Aktiviere Cron Abfrage bei Mitarbeiter aktivit&auml;t';
// TEXT I
$LANG['TEXT_INTERNAL_NOTE_POSTED'] = 'Interne Notiz hinzugef&uuml;gt';
$LANG['TEXT_INVALID_LOGIN'] = 'Ung&uuml;ltiger Login'; 
// TEXT J
// TEXT K
// TEXT L
...
// TEXT O
$LANG['TEXT_OPEN'] = '&Ouml;ffnen';
$LANG['TEXT_OPEN_NEW_TICKET'] = 'Neues Ticket &ouml;ffnen';
$LANG['TEXT_OPEN_PREVIOUS_TICKET'] = 'Pr&uuml;fen sie den Status Ihrer bisher ge&ouml;ffneten Tickets. Wir archivieren Ihre in der Vergangenheit erstellen Tickets.';
//$LANG['TEXT_OPEN_STATS']
$LANG['TEXT_OPEN_TICKETS'] = 'Offene Tickets';
$LANG['TEXT_OF_SELECTED_TICKETS_REOPENED'] = "{0} von {1} ausgew&auml;hlten Tickets erneut ge&ouml;ffnet";
$LANG['TEXT_OF_SELECTED_TICKETS_CLOSED'] = "{0} of {1} ausgew&auml;hlten Tickets geschlossen";
$LANG['TEXT_OF_SELECTED_TICKETS_MARKED_OVERDUE'] = "{0} of {1} ausgew&auml;hlten Tickets als &uuml;berf&auml;llig markiert";
$LANG['TEXT_OF_SELECTED_TICKETS_DELETED'] = "{0} of {1} ausgew&auml;hlten Tickets gel&ouml;scht";
$LANG['TEXT_OFFLINE']='Vielen Dank f&uuml;r Ihre Geduld.<br>'.
         'Unser Supportservice ist aktuell offline, bitte versuchen Sie es sp&auml;ter erneut.';
$LANG['TEXT_OFFLINE_MODE_WILL_DISABLE_CLIENT'] = 'Der Offline Modus deaktiviert das Benutzerinterface und erlaubt den Zugriff auf osTicket <b>nur</b>'.
         ' f&uuml;r <b>Admins</b>';
$LANG['TEXT_PHP_MANUAL'] = 'PHP Dokumentation';
$LANG['TEXT_TICKET_LOCK_RENEW_ON_FORM_ACTIVITY'] = 'Ticket sperren werden automatisch bei Formularaktivit&auml;t erneuert wenn aktiviert.';
$LANG['TEXT_TICKET_OPTIONS_AND_SETTINGS'] = 'Ticket Optionen & Einstellungen';
$LANG['TEXT_OVERDUE'] = '&Uuml;berf&auml;llig';
...
$LANG['TEXT_PRIORITY_CHANGED_SUCCESSFULLY'] = 'Priorit&auml;t erfolgreich ge&auml;ndert';
// TEXT Q
// TEXT R
$LANG['TEXT_REFRESH'] = 'Aktualisieren';
$LANG['TEXT_REQUIRED_WHEN_DEPT_IS_PUBLIC'] = 'Erforderlich wenn die Abteilung &ouml;ffentlich ist';
$LANG['TEXT_RESPONSE_POSTED_SUCCESSFULLY'] = 'Antwort erfolgreich eingetragen';
// TEXT S
$LANG['TEXT_SEARCH_RESULTS'] = 'Suchergebnis';
...
$LANG['TEXT_SELECT_PREMADE_REPLY'] = 'Vorgefertigte Antwort ausw&auml;hlen';
...
$LANG['TEXT_SORT_BY_PRIORITY'] = 'nach Priorit&auml;t sortieren';
...
$LANG['TEXT_TICKET_STATUS_CHANGED_TO'] = 'Ticket Status ge&auml;ndert zu {0}';
$LANG['TEXT_TICKET_STATUS_SET_TO_OPEN'] = 'Ticket GE&Ouml;FFNET';
$LANG['TEXT_TICKET_THREAD'] = 'Ticket Verlauf';
$LANG['TEXT_TICKET_TRANSFERED_SUCESSFULLY_TO_DEPT'] = 'Ticket erfolgreich Abteilung {0} zugewiesen.';
$LANG['TEXT_TICKET_UPDATED_SUCCESSFULLY'] = 'Ticket erfolgreich aktualisiert';
$LANG['TEXT_TICKET_WILL_REOPEN_NEW_POST']='Durch eine erneute Nachricht wird das Ticket wieder ge&ouml;ffnet';
...
$LANG['TEXT_USED_FOR_OUTGOING_EMAILS'] = 'Wird f&uuml;r ausgehende E-Mails, Alarme und Notizen an Kunden und Benutzer genutzt.';
// TEXT V
$LANG['TEXT_VIEW_OPEN']='Offene ansehen';
$LANG['TEXT_VIEW_CLOSED']='Geschlossene ansehen';
$LANG['TEXT_VIEW_TICKET'] = 'Ticket ansehen';
$LANG['TEXT_VISIBLE_TO_CLIENT'] = 'Sichtbar f&uuml;r den Kunden.';
// TEXT X
// TEXT Y
$LANG['TEXT_YOUVE_REACHED_MAXIMUM_FAILED_LOGIN_ATTEMPTS_ALLOWED']='Sie haben das Maximum an Loginversuchen erreicht.';
// TEXT W
$LANG['TEXT_WELCOME_BACK'] = 'Willkommen zur&uuml;ck';
$LANG['TEXT_WELCOME_BACK_CLIENT'] = 'Willkommen zur&uuml;ck, <strong>{0}</strong>';
$LANG['TEXT_WELCOME_BACK_STAFF'] = 'Willkommen zur&uuml;ck, <strong>{0}</strong>';
$LANG['TEXT_WELCOME_BACK_VACATION']= 'Willkommen zur&uuml;ck! Sie sind als \'Im Urlaub\' markiert. Bitte teilen Sie Ihrem Admin oder Abteilungsleiter mit das Sie aus dem Urlaub zur&uuml;ck sind.';
$LANG['TEXT_WELCOME_MSG'] = 'Um Ihnen den optimalen Support bieten zu k&ouml;nnen betreiben wir ein Ticket System. Jeder Supportanfrage wird eine eindeutige Ticket ID zugeweisen, mit der Sie den Fortschritt und die Antwort des Supportteams online einsehen k&ouml;nnen.
...
$LANG['TITLE_OPEN_PREVIOUS_TICKET'] = 'Bestehendes Ticket &ouml;ffnen';
...
$LANG['TABLE_MYACCOUNT_TH_EMAIL'] = 'E-Mail';
$LANG['TABLE_MYACCOUNT_TH_OFFICE_PHONE'] = 'B&uuml;rotelefon';
...
$LANG['TABLE_MYACCOUNT_CHANGE_PWD_TH_NEWPWD2'] = 'Passwort Best&auml;tigung';

#some other stuff
$LANG['LABEL_DATE_FORMAT'] = 'Datumsformat';
$LANG['LABEL_DATETIME_CURRENT'] = 'Datum &amp; Zeit aktuell';
$LANG['LABEL_DATE_AND_TIME_FORMAT'] = 'Datums- &amp; Zeitformat';
$LANG['LABEL_DATE_AND_TIME'] = 'Datum &amp; Zeit';
$LANG['LABEL_DAY_DATE_AND_TIME_FORMAT'] = 'Langes Datums- &amp; Zeitformat';
$LANG['LABEL_DEFAULT_TIME_ZONE'] = 'Standard Zeitzone';
$LANG['LABEL_DATETIME_PREFERRED_TIMEZONE'] = 'Bevorzugte Zeitzone';
$LANG['LABEL_DAYLIGHT_SAVING'] = 'Zeitumstellung';
$LANG['TEXT_OBSERVE_DAYLIGHT_SAVINGS'] = '&nbsp;Sommerzeit ?';
